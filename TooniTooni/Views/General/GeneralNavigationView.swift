...
//  Esports
//
//  Created by GENETORY on 2021/02/22.
//
...
class GeneralNavigationView: BaseCustomView {
    ...
    func initLabels() {
        self.titleLabel.font = UIFont.init(name: kFONT_BOLD, size: 16.0)
        self.titleLabel.textColor = kGRAY_800
        self.titleLabel.textAlignment = .center
        self.titleLabel.text = nil

        self.bigTitleLabel.font = UIFont.init(name: kFONT_BOLD, size: 26.0)
